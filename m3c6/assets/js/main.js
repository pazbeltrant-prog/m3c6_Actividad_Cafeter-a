...
document.addEventListener('DOMContentLoaded', () => {
    ...
    orderButtons.forEach(btn => {
        ...
        btn.addEventListener('click', (e) => {
            ...
            currentBtn.innerText = "🎌 Te llevaremos a la aldea de los próximos eventos";
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('.card .btn-small').forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            // Si es el botón "Ver eventos", mostrar toast personalizado
            if (btn.classList.contains('btn-eventos')) {
                console.log('Es el botón Ver eventos, mostrando toast...');
                showToast('🎌 Te llevaremos a la aldea de los próximos eventos', 'toast-cafe');
                ...
                // Para otros botones, mantener el comportamiento original
                btn.classList.add('is-added');
